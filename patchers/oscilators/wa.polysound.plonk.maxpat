...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 660.0, 435.0, 40.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 660.0, 390.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 473.0, 285.0, 29.5, 22.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 608.0, 240.0, 63.0, 22.0 ],
					"text" : "trigger 1. f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1095.0, 543.0, 33.0, 22.0 ],
					"text" : "* 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 747.0, 585.0, 54.0, 22.0 ],
					"text" : "wa.pan~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1095.0, 510.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 473.0, 135.0, 50.0, 22.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 782.0, 630.0, 42.0, 22.0 ],
					"text" : "out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 135.0, 152.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "decay"
					}
,
					"text" : "in 3 @attr_comment decay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 135.0, 179.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "dampening"
					}
,
					"text" : "in 2 @attr_comment dampening"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 180.0, 61.0, 23.0 ],
					"text" : "decay $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 180.0, 72.0, 23.0 ],
					"text" : "dampen $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 65.0, 44.0, 147.0, 23.0 ],
...
,
					"patching_rect" : [ 747.0, 330.0, 38.0, 23.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 828.0, 473.0, 66.0, 22.0 ],
					"text" : "line~ 1500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 828.0, 441.0, 47.0, 22.0 ],
					"text" : "$1 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 828.0, 315.0, 42.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 849.0, 379.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 849.0, 351.0, 111.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 747.0, 510.0, 181.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 607.0, 195.0, 43.0, 23.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 555.0, 390.0, 60.0, 23.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 747.0, 473.0, 35.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 135.0, 37.0, 23.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 555.0, 330.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 747.0, 660.0, 48.0, 23.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 15.0, 142.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "midi"
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 747.0, 195.0, 48.0, 23.0 ],
					"text" : "1, 0 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 792.0, 240.0, 47.0, 23.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 747.0, 240.0, 37.0, 23.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 747.0, 285.0, 36.0, 23.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 864.5, 120.0, 1104.5, 120.0 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
